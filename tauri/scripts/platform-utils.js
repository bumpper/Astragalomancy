 ...
 * For Astragalomancy Tauri Application
 * 
...
function getPlatformConfig() {
    ...
    const configs = {
        win32: {
            ...
            installerPaths: [
                'msi\\Astragalomancy_1.0.0_x64_en-US.msi',
                'nsis\\Astragalomancy_1.0.0_x64-setup.exe'
            ]
        },
        darwin: {
            name: 'macOS',
            ...
            installerPaths: [
                'dmg/Astragalomancy_1.0.0_x64.dmg',
                'macos/Astragalomancy.app'
            ]
        },
        linux: {
            name: 'Linux',
            ...
            outputDir: 'src-tauri/target/release/bundle',
            installerPaths: [
                'deb/astragalomancy_1.0.0_amd64.deb',
                'appimage/astragalomancy_1.0.0_amd64.AppImage',
                'rpm/astragalomancy-1.0.0-1.x86_64.rpm'
            ]
        }
    };
