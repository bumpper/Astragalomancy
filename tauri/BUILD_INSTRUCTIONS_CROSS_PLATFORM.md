# Cross-Platform Build Instructions for Astragalomancy

This guide provides detailed instructions for building Astragalomancy on Windows, macOS, and Linux (including Fedora for RPM packages).
...
Astragalomancy is built using Tauri 2.0, which allows you to create native desktop applications for multiple platforms. However, **you must build on each target platform** - cross-compilation from Windows to macOS/Linux is not straightforward with Tauri.
...
- **MSI Installer:** `src-tauri\target\release\bundle\msi\Astragalomancy_1.0.0_x64_en-US.msi`
- **NSIS Installer:** `src-tauri\target\release\bundle\nsis\Astragalomancy_1.0.0_x64-setup.exe`
- **Executable:** `src-tauri\target\release\astragalomancy.exe`
...
- **DMG Installer:** `src-tauri/target/release/bundle/dmg/Astragalomancy_1.0.0_aarch64.dmg`
- **App Bundle:** `src-tauri/target/release/bundle/macos/Astragalomancy.app`
...
- **DEB Package:** `src-tauri/target/release/bundle/deb/astragalomancy_1.0.0_amd64.deb`
- **AppImage:** `src-tauri/target/release/bundle/appimage/astragalomancy_1.0.0_amd64.AppImage`
...
- **RPM Package:** `src-tauri/target/release/bundle/rpm/astragalomancy-1.0.0-1.x86_64.rpm`
- **AppImage:** `src-tauri/target/release/bundle/appimage/astragalomancy_1.0.0_amd64.AppImage`
